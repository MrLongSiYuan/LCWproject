...
window.gMain = $.extend((typeof gMain === "undefined"?{}:gMain),{
    ...
    ,DayHRDomains:{
        ...
        ,sCloudDomain:location.protocol + "//oa.daydao.com/"  //day盘域名
        ,sWorkflowDomain:location.protocol + "//workflow.daydao.com/"  //dayoa工作流
        ,sDayhrDomain:location.protocol + "//hr.daydao.com/"  //dayhr
        ,sStoreDomain:location.protocol + "//store.daydao.com/"  //应用市场的域名
        ,sOpenDomain:location.protocol + "//admin.daydao.com/"  //天枢平台的域名
        ...
        ,sUplogsDomain:location.protocol + "//uplogs.daydao.com/"  //uplogs平台的域名
        ,sExtraDomain:location.protocol + "//extra.daydao.com/"  //omss对外公开的服务
        ,sEduYoungDomain:location.protocol + "//edu-young.daydao.com/"  //青葱季域名
        ,sEvaDomain:location.protocol + "//eva.daydao.com/"  //测评项目域名
        ,sDeveloperDomain:location.protocol + "//developer.daydao.com/"  //开阳平台域名
    }
...
// if(jQuery.cookie("greyApp")){
//     gMain.jsdir = "static_grey";
// }
