...
(function ($) {
    ...
    function Scroller(elem, settings) {
        ...
        */
        that.show = function (prevAnim) {
            ...
            var html = '<div class="dw-trans ' + s.theme + ' dw-' + s.display + '">' + (s.display == 'inline' ? '<div class="dw dwbg dwi"><div class="dwwr">' : '<div class="dw-persp">' + '<div class="dwo"></div><div class="dw dwbg ' + mAnim + '"><div class="dw-arrw"><div class="dw-arrw-i"><div class="dw-arr"></div></div></div><div class="dwwr">' + ((s.headerText=false) ? '<div class="dwv"></div>' : ''));
            html += (s.display != 'inline' ? '<div class="dwbc' + (s.button3 ? ' dwbc-p' : '') + '"><span class="dwbw dwb-c"><span class="dwb">' + s.cancelText + '</span></span>' + (s.button3 ? '<span class="dwbw dwb-n"><span class="dwb">' + s.button3Text + '</span></span>' : '') + '<span class="dwbw dwb-s"><span class="dwb">' + s.setText + '</span></span></div></div>' : '<div class="dwcc"></div>') + '';
    ...
    $.fn.mobiscrollDT = function (method) {
        extend(this, $.mobiscrollDT.shorts);
        return init(this, method, arguments);
    };

    $.mobiscrollDT = $.mobiscrollDT || {
        /**
    ...
    $.scrollerDT = $.scrollerDT || $.mobiscrollDT;
    $.fn.scrollerDT = $.fn.scrollerDT || $.fn.mobiscrollDT;
