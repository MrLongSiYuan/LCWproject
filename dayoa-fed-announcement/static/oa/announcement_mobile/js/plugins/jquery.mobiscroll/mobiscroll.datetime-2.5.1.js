define(function(require, exports, module){
    ...
    (function ($) {
            ...
            preset = function (inst) {
                ...
                if (p.match(/date/i)) {
                    ...
                    for (k = 0; k < 3; k++) {
                        if (k == o.y) {
                            ...
                            for (i = start; i <= end; i++) {
                                w[s.yearText][i] = dord.match(/yy/i) ? (i + '年') : (i + '年').substr(2, 2);
                            }
                        } else if (k == o.m) {
                            offset++;
                            w[s.monthText] = {};
                ...
                if (p.match(/time/i)) {
                    ...
                    for (k = offset; k < offset + 4; k++) {
                        if (k == o.h) {
                            ...
                            w[s.ampmText] = { 0: upper ? 'AM' : '上午', 1: upper ? 'PM' : '下午' };
                        }
                ...
                return {
                    ...
                    formatResult: function (d) {
                        return ms.formatDate(format, getDate(d), s, getAmPm2(d));
                    },
                    /**
                    ...
                    methods: {
                        ...
                        getDate: function (temp) {
                            var inst = $(this).mobiscrollDT('getInst');
                            if (inst) {
         ...
         */
        ms.formatDate = function (format, date, settings, ampm) {
            var s = settings;
            if(s.custom == "ampm"){
                format = "yyyy-mm-dd";
            }else if(s.custom == "hm"){
                format = "yyyy-mm-dd HH:ii"; //24小时制
            }
            ...
            if(s.custom == "ampm" && ampm) output += " " + ampm;
            return output;
        };
