...
<template>
    <div class="page_table_data_list clearfix" :style="{minHeight:iPageTableDataListHeight + 'px'}">
        ...
        <slot name="page-search">
            ...
            <slot name="page-btn-group" v-if="searchCondition.length==0">
                <btn-group :btns="defineBtns"></btn-group>
            </slot>
        ...
        <slot name="page-tree-menu">
            <div id="page_dropdown_inner" v-if="navigationData.length">
                <drop-tree-menu
                    v-if="isDrop"
                    ref="treeMenu"
            ...
            <transition name="fade" mode="out-in">
                ...
                <slot name="table-list">
                    <table-list
                        ...
                        :isShowPreviewDataBtn="isShowPreviewDataBtn"
 ...
 * 更改
 * 1、tableHeight: 
 * 2、iPageTableDataListHeight min-height的loading
 */
import tableList from "components/common/tableList/tableList"; //表格列表
    ...
    export default {
        ...
        ,data:function () {
            ...
            return {
                ...
                ,iPageTableDataListHeight: this.tableHeight
                ,highSearchStyle:''
        ...
        ,mounted:function () {
            ...
            /* $(window).on("resize",function () {
                ...
                timerResize = setTimeout(function () {
                    t.iPageTableDataListHeight = $(window).height() - $("#header_crosswise_bar").height() - 100;
                },200);
            }); */
...
//                }
                    ,success:function (data) {
                        if(data.result == "true"){
                            ...
                            setTimeout(function(){
                                    ...
                                    if(t.$refs.treeMenu){
                                        ...
                                        var getTreeMenu = new Promise(function(resolve , reject){
                                            ...
                                            if (t.$refs.treeMenu.treeMenuName === "dropTreeMenu") {
                                                t.$refs.treeMenu.getLeftTreeMenuData({archive:!!t.isShowDisableOrgTool} , resolve)
                                ...
                                t.$refs.tableList.setTableHeight();
                            },100)
            ...
            ,exportExcel(){
                var t = this;
                 if(t.infoSetId == "perf_record_list"){
                    t.oQueryData.navigationCondition = t.oQueryData.editCondition;//导出单个活动考核记录
                }
            ...
            ,onCurrentChange(currentRow, oldCurrentRow) {
                var t = this;
                t.$emit("on-current-change",arguments);
            }
            /**
             * 行的单击事件
             * */
            ...
            ,onRowDblclick(oItem){
                var t = this;
                t.$emit("on-row-dblclick",arguments);
            }
            /**
             * 选择数据
             * */
