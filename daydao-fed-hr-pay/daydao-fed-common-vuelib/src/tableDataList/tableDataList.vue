...
<template>
    <div :class="[prefixCls, 'clearfix']" :style="{minHeight:iPageTableDataListHeight + 'px'}">
        ...
        <slot name="page-search">
            <template v-if="hasHeightSearch">
                <template v-if="searchCondition.length>0">
                    <high-search
                ...
                <template v-else>
                    <slot name="page-btn-group">
                        <div class="hs-head">
                            <btn-group :btns="defineBtns" :oStyle="{marginBottom:'10px'}"></btn-group>
                        </div>
                    </slot>
                </template>
            </template>
            ...
            <transition name="fade" mode="out-in">
                ...
                <slot name="table-list">
                    <table-list
                        ...
                        :is-show-serial-index-number="isShowSerialIndexNumber"
    ...
    export default {
        ...
        ,methods: {
            ...
            clickMenuCallback:function (event, treeId, treeNode) {
                var t = this;
                t.oQueryData.pageBean.pageNo = '1'; //从第一页开始
                    ...
                    ,success:function (data) {
                        if(data.result == "true"){
                            ...
                            setTimeout(function(){
                                ...
                                setTimeout(function () {
                                    t.$refs.tableList && t.$refs.tableList.setTableHeight(); //重新计算表格高度
                                },500);
                            },100);
