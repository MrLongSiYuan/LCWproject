    ...
    methods: {
                    ...
                    ,success:function (data) {
                        if(data.result == "true"){
                            if(data.data.auditStyle){
                                ...
                                let aData = JSON.parse(data.data.auditStyle);
                                let aAudit = aData.auditPersonList;
        ...
        saveDate(){
            ...
            if($.isArray(aStyle)) {
                ...
                let oJson = {
                    auditStyle: JSON.stringify({auditPersonList:aStyle})
                }
                    ...
                    ,success:function (data) {
                        if(data.result == "true"){
                            if(data.data.auditStyleId){
                                ...
                                t.$emit('workflowSure',t.auditStyleId);
