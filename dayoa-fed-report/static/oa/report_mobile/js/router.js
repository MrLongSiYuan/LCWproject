...
define(function(require, exports, module) {
    ...
    router.map({
        ...
        '/received': {
            component: function (resolve) {
                require.async(['js/category/received.js'],resolve);
            },
            subRoutes:{
                "/reportSearch": {
                    component: function (resolve) {
                        require.async(['js/modules/reportSearch/reportSearch.js'], resolve);
                    }
                },
                "/clipboard": {
                    component: function (resolve) {
         ...
         * 添加汇报
         * */
        '/addReport/:temp_id/:form_id/:handle': {
            component: function (resolve) {
                require.async(['js/category/addReport.js'],resolve);
            },
            subRoutes:{
                /*多选框*/
                "/chooseCover": {
         ...
         * 编辑草稿
         * */
        '/draftEdit/:report_id/:handle': {
            component: function (resolve) {
                require.async(['js/category/draftEdit.js'],resolve);
            },
            subRoutes:{
                "/chooseCover": {
                    component: function (resolve) {
         ...
         * 单个汇报查看
         * */
        '/singleReportDetail/:report_id': {
            component: function (resolve) {
                require.async(['js/category/singleReportDetail.js'],resolve);
            },
            subRoutes:{
                /*
                * 添加评论
